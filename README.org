#+TITLE: Library as a Gem - libpng
#+LATEX: \pagebreak

* Overview

  ~laag-libpng~ packages [[https://libpng.sourceforge.io/][libpng]] as a Ruby Gem, using [[https://github.com/colstrom/laag][laag]].
...
* Updating this Package
  ...
  #+BEGIN_SRC shell
    git-vendor update libpng v1.6.34
  #+END_SRC
